...
The "trained-models" file and the dehazing results for "SOTS-indoor" and "SOTS-outdoor" can be downloaded from this link with the "[Baidu Cloud](https://pan.baidu.com/s/1LxT6Zlvm6nsFNMdBt3Zp0g?pwd=5fdi)" and password: "5fdi". (Due to the accidental deletion of the weight files by Baidu Cloud, we re-uploaded the weight files for the RESIDE dataset on October 29, 2024.)
